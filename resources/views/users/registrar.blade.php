...
<div class="content text-blue">
    <div class="">
      ...
      <form id="form" class="form-horizontal" role="form" method="POST" action="{{ route('registrarcv') }}" enctype="multipart/form-data" files="true">
        {{csrf_field()}}
        <fieldset>
        <legend>Informações Pessoais:</legend>
          ...
          <div class="col-sm-8">
            <textarea id="rd" name="xp" class="form-control" rows="4" style="resize:none" ></textarea>
          </div>
        </div>
          <div class="form-group">
        ...
        <fieldset>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-8">
              <textarea id="atividades" name="atividades" class="form-control" rows="4" style="resize:none" ></textarea>
            </div>
          </div>
          <div class="form-group">
            <label for="xp" class="col-sm-2 control-label">Experiência profissional</label>
            <div class="col-sm-8">
              <textarea id="xp" name="xp" class="form-control" rows="4" style="resize:none" ></textarea>
            </div>
          </div>
        </fieldset>
        <div class="form-group">
